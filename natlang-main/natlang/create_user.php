...
<h4 class="text-center">DETECTING VIOLENT CONVERSATIONS ON SOCIAL MEDIA IN PRESENCE OF CODED AND NATURAL LANGUAGE</h4>
                ...
                <div class="table table-responsive col-md-12">
                         ...
                         <div class="col-md-4 col-md-offset-3" style="border:1px dotted red;">
                   <form action="" method="POST">
                   <legend class="text-center" style="font-weight:bold;color:red;">Register</legend>
                    <p class="text-center" style="font-weight:;color:red;"><?php echo @$error;  ?></p>
<div class="form-group"><label>Username</label><input type="text" name="username" class="form-control" required=""></div>

<div class="form-group"><label>Password</label><input type="password" name="password" class="form-control" required=""></div>
<div class="form-group"><input type="submit" name="register" class="form-control btn btn-success" value="Register"></div>
Already Registered? <a href="logreg" class="pull-right btn btn-primary">Login</a>
<h1></h1>
                   </form>
